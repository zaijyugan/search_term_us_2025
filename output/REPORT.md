...
生成时间：2026-07-23 04:13:05｜数据：美国站 ABA 2025 全年 12 月
...
满足任一条件即入选（Phase5命中×品类 / Phase5命中×趋势<0.7 / 品类新入榜 / 品类季节spike / 裸场景词×优质词族），去重后按 best_rank 排序。完整表见 `candidates.csv`。

共 **1523** 个候选。top 20：

| term | best_rank | present | trend | 品类 | 入选理由 |
|---|--:|--:|--:|:--:|---|
| jewelry box | 330 | 12 | 0.47 | ✓ | 品类季节spike |
| divorced sister | 363 | 7 | 61.69 |  | 裸场景词×优质词族 |
| kendra scott necklace | 541 | 12 | 0.33 | ✓ | 品类季节spike |
| bracelet making kit | 631 | 12 | 0.36 | ✓ | 品类季节spike |
| ring | 641 | 12 | 0.68 | ✓ | 品类季节spike |
| pandora charms | 820 | 12 | 1.02 | ✓ | 品类季节spike |
| graduation gifts for her | 983 | 12 | 0.55 |  | Phase5命中×趋势向好 |
| tiffany & co jewelry | 1001 | 10 | 1.05 | ✓ | 品类季节spike |
| cross necklace for women | 1003 | 12 | 0.76 | ✓ | 品类季节spike |
| gold earrings | 1033 | 12 | 0.29 | ✓ | 品类季节spike |
| christmas earrings | 1210 | 6 | 0.02 | ✓ | 品类季节spike；品类新入榜 |
| ankle bracelets for women | 1439 | 12 | 1.67 | ✓ | 品类季节spike |
| necklace | 1441 | 12 | 0.44 | ✓ | 品类季节spike |
...
**4B 被纪念对象（词典外，按词数）：** for(56), gifts(43), 50th(15), of(13), baby(12), hat(10), decorations(10), 250th(10), gift(9), card(9), cards(9), wedding(8), the(8), sleep(8), 25th(7), blanket(7), dog(7), loss(7), book(6), 30th(6), ps5(6), happy(6), shirt(5), princess(5), pet(5)
